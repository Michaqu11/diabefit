...
import { Button, Container, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Grid, InputAdornment, Paper, Stack, TextField } from "@mui/material";
...
const CustomMealDialog: React.FC<Props> = ({ meal, setMeal, open, setOpen, uncheckMeal, saveMeal }) => {
    ...
    return (
        <React.Fragment>
            <Dialog open={open} onClose={handleCancel}>
                <DialogTitle sx={{ padding: '8px 24px' }}>Configure your meal</DialogTitle>
                <DialogContent>
